...
//			if (coord.getY() == columns.get(coord.getX()+x).size()-2){
//				
//			}
//			
...
//				for (Box box : columns.get(columns.size() - 2)) {
//					if (!box.isEmpty()){
//						isEmpty = false;
//						break;
//					}
...
//				if (isEmpty)
//					columns.remove(1);
//				if (columns.get(columns.size() - 2).size() == 0)
...
//						System.out.println("box="+column.get(0).get(0)+" pi="+column.get(0).get(0)==null?null:column.get(0).get(0).getPiece());
//						isEmpty = false;
//						break;
//					}
//				}
