...
public class HeuristicConst {
    ...
    public static final double[] AI_QUEEN = {0.5, 0, 1, -80, 0, 0, -18};
    public static final double[] AI_SPIDER = {0.5, 0.5, 0.5, 0, 1, 1.1, -1};
    public static final double[] AI_GH = {0.5, 0.5, 0.5, 0, 1, 1.1, -1};
    public static final double[] AI_BEETLE = {0.5, 0.5, 0.5, 0, 1, 1.1, -1};
    public static final double[] AI_ANT = {0.5, 0.5, 0.5, 0, 1, 1.1, -1};
    public static final double[] AI_GENERAL = {0, 0, 0, 0, 0, 0, -1};
    public static final double[] HUM_QUEEN = {-0.5, -0.5, -0.5, 80, -1, -0.5, 18};
    public static final double[] HUM_SPIDER = {-0.5, -0.5, -0.5, 0, -1, -1.1, 1};
    public static final double[] HUM_GH = {-0.5, -0.5, -0.5, 0, -1, -1.1, 1};
    public static final double[] HUM_BEETLE = {-0.5, -0.5, -0.5, 0, -1, -1.1, 1};
    public static final double[] HUM_ANT = {-0.5, -0.5, -0.5, 0, -1, -1.1, 1};
    public static final double[] HUM_GENERAL = {-0, -0, -0, 0, 0, 0, 1};

    public static final double[][][] getHeuristicDataFromConsts() {
        double[][][] heuristicData = new double[2][6][7];

        heuristicData[0][0] = AI_QUEEN;
        heuristicData[0][1] = AI_SPIDER;
        heuristicData[0][2] = AI_GH;
        heuristicData[0][3] = AI_BEETLE;
        heuristicData[0][4] = AI_ANT;
        heuristicData[0][5] = AI_GENERAL;

        heuristicData[1][0] = HUM_QUEEN;
        heuristicData[1][1] = HUM_SPIDER;
        heuristicData[1][2] = HUM_GH;
        heuristicData[1][3] = HUM_BEETLE;
        heuristicData[1][4] = HUM_ANT;
        heuristicData[1][5] = HUM_GENERAL;
