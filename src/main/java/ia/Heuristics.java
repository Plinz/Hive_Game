...
public class Heuristics {
	...
	public boolean OpponentsQueenSurroundedExceptGates(int player) {
		...
		List<CoordGene<Integer>> possibleDest = extraAnt.getPossibleMovement(
				this.core.getBoard().getTile(northest.getCoord().getNorthWest()), this.core.getBoard());
	...
	// public int grassHopperToOpponentsQueensFreeNeighbor(int player, Tile
	// tile)
	// {
	// int turn = 0;
	...
	// {
	// for (CoordGene coords : tileElem.getPiece().getPossibleMovement(tileElem,
	// this.core.getBoard()))
	// {
	// if (!(markedTiles.contains(this.core.getBoard().getTile(coords))))
	// {
	// if (this.isOpponentsQueenNeighbor(player,
	// this.core.getBoard().getTile(coords)))
	// {
	// destFound = true;
	// break;
	// }
	...
	public ArrayList<CoordGene<Integer>> grassHopperToOpponentsQueensFreeNeighbor(int player, Tile tile) {
		...
		do {
			for (ArrayList<CoordGene<Integer>> subList : mainList) {
				...
				for (CoordGene<Integer> coord : this.core.getBoard().getTile(subList.get(subList.size() - 1)).getPiece()
						.getPossibleMovement(this.core.getBoard().getTile(subList.get(subList.size() - 1)),
								this.core.getBoard())) {
